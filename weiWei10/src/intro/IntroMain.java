...
public class IntroMain 
{
  ...
  //another line of text
	...
	public static final String[] DESCRIPTIONS = {" is a noob"," is a supernoob"};
	
	//the first method that is executed. Must be independent of instances.
	
	public static void main(String[] args)
	{
		//a declaration of an instance of CodingConventions
		//in the same line of code, it is also being instantiated 
		//note the use of the word "new". Always used when calling constructors
		...
		for(int i = 0; i <10; i++)
		{
			...
			CodingConventions conventionsInstance = new CodingConventions("Wei", i%2);
